    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="../">CoffeeControl</a>
                </li>

                <?php
                if (basename($_SERVER['PHP_SELF']) <> "index.php") {
                    echo "<li class='nav-item'>";
                    echo "<a class='nav-link' href='.'>Regresar</a>";
                    echo "</li>";
                }
                if (basename($_SERVER['PHP_SELF']) <> "add.php") {
                    echo "<li class='nav-item'>";
                    echo "<a class='nav-link' href='add.php'>Agregar Producto</a>";
                    echo "</li>";
                }
                ?>

                <!-- <li class="nav-item">
                    <a class="nav-link" href="../../liquidity/">Liquidez</a>
                </li> -->
            </ul>
            <span>
